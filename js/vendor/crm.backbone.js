(function($, _, Backbone) {
   ...
   * The issue pointed to the line where the Backbone variable were first used.
   * The issue was verified with the debug tool. This function input Backbone was
   * undefined, but the window.Backbone were defined.
   * This if branch is for fixing the issue. If the Backbone is undefined, fallback to
   * the window.Backbone.
   * */

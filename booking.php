  ...
  if ($administerMenuId) {
    ...
    $params[$administerMenuId]['child'][$nextAdminMenuKey] =  array(
        ...
        'child' =>  array(
          $key++ => array(
            'attributes' => array(
              'label' => E::ts('Resource Configuration Set'),
          ...
          $key++ => array(
            'attributes' => array(
              'label' => E::ts('Additional Charges Item'),
          ...
          $key++ => array(
            'attributes' => array(
              'label' => E::ts('Cancellation Charges'),
          ...
          $key++ => array(
            'attributes' => array(
              'label' => E::ts('Booking Component Settings'),

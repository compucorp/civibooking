      ...
      <table id="" class="display">
        ...
        {foreach from=$resources key=key item=resource}
          <tr id="crm-booking-resource-row-{$key}" class="">
            ...
            <td class="crm-booking-resource-price"><span data-ref="{$key}" id="resource-price-{$key}">{$resource.price|crmMoney:$currency}</span></td>
            <td class="crm-booking-resource-total-price"><span data-ref="{$key}" data-price="{$resource.price}" id="resource-total-price-{$key}">{$resource.price|crmMoney:$currency}<span></td>
            <td >
        ...
        <tr>
          ...
          <td><span id="sub-total-summary">{$subTotal|crmMoney:$currency}</span></td>
          <td></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><span id="total-price-summary">{$totalPrice|crmMoney:$currency}</span></td>
          <td></td>
        </tbody>
      </table>
    </div>

...
<div id="ltype">
        ...
        <div class="action-link">
          <a href="{crmURL q="action=add&reset=1&pp=2"}" id="new" class="button"><span><div class="icon add-icon"></div>{ts}Add Resource{/ts}</span></a>
        </div>
        {/if}
</div>
{elseif $action ne 1}
    <div class="messages status no-popup">
     ...
     <div class="action-link">
       <a href="{crmURL p='civicrm/admin/resource' q="action=add&reset=1&pp=2"}" id="newResource" class="button"><span><div class="icon add-icon"></div>{ts}Add Resource{/ts}</span></a>
     </div>
{/if}
{/if}

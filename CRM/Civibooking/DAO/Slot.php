 ...
 * @copyright CiviCRM LLC (c) 2004-2013
 *
 * Generated from xml/schema/CRM/CiviBooking/Slot.xml
 * DO NOT EDIT.  Generated by GenCode.php
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_CiviBooking_DAO_Slot extends CRM_Core_DAO
{
  /**
    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'config_id' => array(
          'name' => 'config_id',
          'type' => CRM_Utils_Type::T_INT,
          'FKClassName' => 'CRM_CiviBooking_DAO_ResourceConfigOption',
        ) ,
        'start' => array(
          'name' => 'start',

    ...
    if (!(self::$_links)) {
      self::$_links = array(
        ...
        CRM_Core_Action::DISABLE => array(
          'name' => ts('Disable'),
          'extra' => 'onclick = "enableDisable( %%id%%,\'' . 'CRM_Booking_BAO_ResourceConfigSet' . '\',\'' . 'enable-disable' . '\' );"',
          'ref' => 'disable-action',
          'title' => ts('Disable Resource Configuration Set'),
        ),
        CRM_Core_Action::ENABLE => array(
          'name' => ts('Enable'),
          'extra' => 'onclick = "enableDisable( %%id%%,\'' . 'CRM_Booking_BAO_ResourceConfigSet' . '\',\'' . 'disable-enable' . '\' );"',
          'ref' => 'enable-action',

 ...
 *
 */
class CRM_Booking_StateMachine_Search extends CRM_Core_StateMachine {
   ...
   */ function __construct($controller, $action = CRM_Core_Action::NONE) {
    ...
    $this->_pages['CRM_Booking_Form_Search'] = NULL;
    ...
    if ($result) {
      $this->_pages['CRM_Booking_Form_Task_Result'] = NULL;
    }
  ...
  function taskName($controller, $formName = 'Search') {
    ...
    return CRM_Booking_Form_Task::getTask($value);
  }

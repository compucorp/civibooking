...
class CRM_Booking_Upgrader extends CRM_Booking_Upgrader_Base {
  ...
  public function install() {
    ...
    //check if it exist in case of re-installation
  ...
  public function upgrade_1100() {
    Civi::log()->info('Applying update 1100');
  ...
  /**
   * Deprecated. The navigation menu building process is now handled with a hook.

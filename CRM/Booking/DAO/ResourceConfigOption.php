    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'set_id' => array(
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Set ID') ,
          'description' => 'Foreign key to the resource set for this option.',
          'required' => true,
        ...
        'unit_id' => array(
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => ts('Unit ID') ,
          'description' => 'The unit associated with this config option. Implicit FK to option_value row in booking_size_unit option_group.',
          'maxlength' => 512,
          'size' => CRM_Utils_Type::HUGE,

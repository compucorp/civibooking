    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'booking_status_id' => array(
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Status ID') ,
          'description' => 'The status associated with this booking. Implicit FK to option_value row in booking status option_group.',
          'required' => true,
          'export' => true,
        ...
        'total_amount' => array(
          ...
          'description' => 'Total amount of this booking calculated from slots,sub slots, ad-hoc charges and discount amount',
          'required' => true,
          'precision' => array(
            20,
            2

    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'log_confirmation_email' => array(
          ...
          'description' => 'Create an activity record againt contact for conformation emails',
          'required' => true,
        ) ,
        'unlimited_resource_time_config' => array(
          ...
          'description' => 'Only allow unlimited resources to be booked within time span of the parent limited resource booking',
          'required' => true,
          'default' => '1',
        ) ,

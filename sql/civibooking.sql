...
CREATE TABLE `civicrm_booking` (
     ...
     `primary_contact_id` int unsigned    COMMENT 'FK to Contact ID',
     `secondary_contact_id` int unsigned    COMMENT 'FK to Contact ID',
...
CREATE TABLE `civicrm_booking_resource` (
     ...
     `resource_location` varchar(512) NOT NULL   COMMENT 'Type of resource location, link to option group',
...
CREATE TABLE `civicrm_booking_resource_config_option` (
     ...
     `unit_id` varchar(512) NOT NULL   COMMENT 'Type of units, link to option group',
     `weight` int unsigned NOT NULL   ,
     `is_enabled` tinyint NOT NULL  DEFAULT 1  
,
    PRIMARY KEY ( `id` )
